...
def expositions():
    ...
    expositions = db.db.api.find({"fields.category": { "$regex": '^Expositions' }}, {"fields.title":1, "fields.category": 1, "fields.date_end": 1, "fields.cover_url":1}).sort([("fields.date_end", -1)]).limit(8)
